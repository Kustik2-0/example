package net.kustik.example3.entity.client;
...
public class TigerModel extends GeoModel<TigerEntity> {
    ...
    public Identifier getModelResource(TigerEntity animatable) {
        return new Identifier(Example3.MOD_ID, "geo/tiger.geo.json");
    }

    @Override
    public Identifier getTextureResource(TigerEntity animatable) {
        return new Identifier(Example3.MOD_ID, "textures/entity/tiger.png");
    }

    @Override
    public Identifier getAnimationResource(TigerEntity animatable) {
        return new Identifier(Example3.MOD_ID, "animations/tiger.animation.json");
    }
